...
var Table = []Row{
	...
	{D43: 9, From: StateArmed, Event: EvWatchdogOverrun, To: StateArmed,
		...
		SideEffects: []string{"kws.keep-alive-alert"}}, // D32③: KWS must NOT be unloaded
	...
	{D43: 21, From: StateConfirming, Event: EvConfirmExpired, To: StateActing,
		SideEffects: []string{"tools.execute"}}, // fs.write MUST be temp+rename (C19)
	...
	{D43: 29, From: StateWarm, Event: EvSummon, To: StateListening, Listen: PhaseInSession,
		SideEffects: []string{"session.zero-load-resume"}}, // B4: zero model loading
	...
	{D43: 38, From: StateError, Event: EvErrorAck, To: StateWarm,
		SideEffects: []string{"error.ack"}}, // restore target resolved by the error.ack consumer
