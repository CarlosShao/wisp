...
- [ ] **续#2（= `R-131-2`）**：注册时带上"被驱入口的符号名"，门核一次"那枚钉的调用闭包里含不含这条腿的入口函数"
...
- [ ] **续#3（= `R-131-4`，纯措辞，顺手）**：`cmd/wisp/slo_windows.go:179` 的 `WISP-LEG-SINK-RULING:` 段写着
