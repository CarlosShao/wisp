...
- 快照：`/d/tmp/wisp124-2b2-r2-post` = `git archive e113b1a | tar -x`（**1048 文件**；`dfa3dc4` 那台是 1046，+2 逐名是 `docs/evidence/s1/124-ac2b-2-conversion.md`（本文件，前任 `4a23de5` 起）与 `docs/evidence/s1/133-ac1-ac2-instrument.md`（兄弟票 133），`git diff --name-status dfa3dc4 e113b1a` 里只有这两枚 `A`）。对照快照 `/d/tmp/wisp124-2b2-r2-pre` = `git archive 5417a3c`（1039 文件，§0 的 pre 锚，只用于 §7.4 的归因那一发）。
