...
这与票面 41-43 行的措辞一致（它要补的是"验收方实测能滑过去的两形"），我不因此降格，但也不让它被读成"生产判定改了"。
